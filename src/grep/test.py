...
template = '[0-9]'
test_file = './test_files/test_0_grep.txt'
test_template = './test_files/test_template'
...
for index in range(len(suite_flag)):
    ...
    system(f'{your_cat} {suite_flag[index]} > {file_name + "-0" + file_format}')
    system(f'{system_cat} {suite_flag[index]} > {file_name + "-1" + file_format}')
